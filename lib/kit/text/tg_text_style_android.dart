...
class TGTextStyleAndroid implements TGTextStyle {
  @override
  TextStyle gigant = TextStyle(
    fontFamily: 'Roboto',
  ...
  @override
  TextStyle style28Medium = TextStyle(
    fontFamily: 'Roboto',
    fontWeight: FontWeight.w500,
    fontSize: 28.sp,
    height: 1.1,
  ...
  @override
  TextStyle style17Semibold = TextStyle(
    fontFamily: 'Roboto',
    fontWeight: FontWeight.w500,
    fontSize: 17.sp,
    height: 1.35,
  ...
  @override
  TextStyle style17Underlined = TextStyle(
    fontFamily: 'Roboto',
    fontWeight: FontWeight.normal,
    fontSize: 17.sp,
    height: 1.41,
  ...
  @override
  TextStyle style14Semibold = TextStyle(
    fontFamily: 'Roboto',
    fontWeight: FontWeight.w500,
    fontSize: 14.sp,
    height: 1.22,
